...
public class CountdownTimer extends Sprite {
    ...
    public function start(_arg_1:int = 5):void {
        ...
        this.myTimer.addEventListener("timer", this.countdown);
        this.myTimer.start();
    }
    ...
    public function end():void {
        ...
        if (this.myTimer != null) {
            this.myTimer.removeEventListener("timer", this.countdown);
            this.myTimer.reset();
        }
    }

    public function remove():void {
        if (this.background != null && this.background.parent) {
            removeChild(this.background);
        }
