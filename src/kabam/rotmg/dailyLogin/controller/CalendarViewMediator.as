...
public class CalendarViewMediator extends Mediator {
    ...
    private function onClaimReward(param1:ClaimDailyRewardResponse):void {
        ...
        if (param1.gold > 0) {
            _loc2_ = "gold";
            this.addTextLine.dispatch(ChatMessage.make("", (param1.gold > 0 ? param1.gold : int(param1.quantity)) + "x " + _loc2_ + " was claimed.", -1, -1, "", false));
            ...
            this.addTextLine.dispatch(ChatMessage.make("", (param1.gold > 0 ? param1.gold : int(param1.quantity)) + "x " + _loc2_ + " was claimed and will be sent to the gift chests in your vault.", -1, -1, "", false));
        }
    }
}
}
