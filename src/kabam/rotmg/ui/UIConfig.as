...
import com.company.assembleegameclient.ui.exaltation.ExaltationMediator;
...
import com.company.assembleegameclient.ui.vault.VaultMediator;
...
public class UIConfig implements IConfig {
    ...
    public function configure():void {
        ...
        this.mediatorMap.map(ExaltationView).toMediator(ExaltationMediator);
        this.mediatorMap.map(VaultView).toMediator(VaultMediator);
        this.setupKeyUI();
