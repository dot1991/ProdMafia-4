...
public class BadDomainView extends Sprite {
    ...
    public function BadDomainView() {
        ...
        _local1.htmlText = "<p align=\"center\"><font color=\"#FFFFFF\">Play at: <br/></font><font color=\"#7777EE\"><a href=\"http://www.realmofthemadgod.com/\">www.realmofthemadgod.com</font></a></p>";
        _local1.width = 800;
        _local1.y = 300 - _local1.height / 2;
        addChild(_local1);
    }
}
}
