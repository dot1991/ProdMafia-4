...
public class SpamFilter {
    ...
    private function createFilterTable():Array {
        var _loc3_:* = null;
        var _loc2_:* = [];
        var _loc1_:* = ["Aa", "Bb", "Cc", "Dd", "Ee", "Ff", "Gg", "Hh", "Ii", "Jj", "Kk", "Ll", "Mm", "Nn", "Oo", "Pp", "Qq", "Rr", "Ss", "Tt", "Uu", "Vv", "Ww", "Xx", "Yy", "Zz", "00", "11", "22", "33", "44", "55", "66", "77", "88", "99"];
        var _loc4_:* = _loc1_;
        var _loc7_:int = 0;
        var _loc6_:* = _loc1_;
        for each(_loc3_ in _loc1_) {
            _loc2_[_loc3_.charCodeAt(0)] = _loc3_.charAt(1);
            _loc2_[_loc3_.charCodeAt(1)] = _loc3_.charAt(1);
        }
        return _loc2_;
    }
    ...
    private function applyFilterOn(param1:String):String {
        ...
        while (_loc4_ < param1.length) {
            _loc3_ = this.filterTable[param1.charCodeAt(_loc4_)];
            if (_loc3_ !== null) {
                _loc2_.push(_loc3_);
            }
            _loc4_++;
    ...
    private function returnAppropriatePatterns():Array {
        ...
        var _loc2_:int = 0;
        var _loc4_:int = 0;
        while (_loc4_ < this.newPatterns.length) {
            _loc3_ = "";
            _loc2_ = 0;
            while (_loc2_ < this.newPatterns[_loc4_].length) {
                if (this.newPatterns[_loc4_].charAt(_loc2_) != "\'" && this.newPatterns[_loc4_].charAt(_loc2_) != "\"") {
                    _loc3_ = _loc3_.concat(this.newPatterns[_loc4_].charAt(_loc2_));
                }
                _loc2_++;
            }
            this.newPatterns[_loc4_] = _loc3_;
            _loc4_++;
        }
        var _loc1_:Array = this.newPatterns;
        _loc1_.sort();
