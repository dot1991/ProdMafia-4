            ...
            if (!_loc20_) {
                ...
                switch (_loc31_) {
                    ...
                    case "HealNova":
                        ...
                        this.effects.push(new Effect("EquipmentToolTip.partyHeal", {
                            "effect": new AppendingLineBuilder().pushParams("EquipmentToolTip.partyHealAmount", {
                    ...
                    case "Magic":
                        ...
                        continue;
                    case "MagicNova":
                        this.effects.push(new Effect("EquipmentToolTip.partyFill", {
                            "effect": new AppendingLineBuilder().pushParams("EquipmentToolTip.partyFillAmount", {
                                "amount": _loc17_.@amount,
                                "range": _loc17_.@range
                            }, TooltipHelper.getOpenTag(16777103), TooltipHelper.getCloseTag())
                        }));
