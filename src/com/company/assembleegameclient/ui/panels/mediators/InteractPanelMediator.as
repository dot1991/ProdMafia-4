...
public class InteractPanelMediator extends Mediator {
    ...
    private function doShowPet():Boolean {
        ...
        return this.mapModel && this.mapModel.currentInteractiveTarget is Pet && this.currentInteractive is Pet && this.isMapNameYardName() && Pet(this.mapModel.currentInteractiveTarget).vo.getID() != Pet(this.currentInteractive).vo.getID();
    }
