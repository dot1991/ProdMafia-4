...
public class TweenLite extends Animation {
    ...
    protected static function _applyOverwrite(target:Object, tween:TweenLite, props:Object, mode:int, siblings:Array):Boolean {
        ...
        var startTime:Number = tween._startTime + 0.0000000001, overlaps:Array = [], oCount:int = 0,
                zeroDur:Boolean = (tween._duration == 0), globalStart:Number;
        i = siblings.length;
        while (--i > -1) {
            curTween = siblings[i];
...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------
    ...
    override public function _kill(vars:Object = null, target:Object = null):Boolean {
        ...
        var i:int, overwrittenProps:Object, p:String, pt:PropTween, propLookup:Object, changed:Boolean,
                killProps:Object, record:Boolean;
