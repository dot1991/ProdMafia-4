...
public class CaretakerQueryDetailBubble extends Sprite {
    ...
    private function makeText():TextFieldDisplayConcrete {
        return new TextFieldDisplayConcrete().setSize(16).setLeading(3).setAutoSize("left").setVerticalAlign("top").setMultiLine(true).setWordWrap(true).setPosition(8, 8).setTextWidth(425).setTextHeight(236);
    }
    ...
    private function makeBubble():void {
        ...
        var _loc1_:BevelRect = new BevelRect(441, this.textfield.height + 16, 4);
